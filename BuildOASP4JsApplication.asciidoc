...
One simple text field, one text field with email validation (and the legal information regarding emails) and a number field. So the final code with the form added will look like this:
