...
Another option to get this basic project structure with all its dependencies and styles already set is to clone the develop branch of https://github.com/oasp/oasp4js-application-template[OASP4JS Application Template].
