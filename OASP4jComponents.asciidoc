...
The 'Target' should match the table name in the data base although is not mandatory.
...
Going back to our example application [TODO: *LINK TO JumpTheQueue Reference*] _Jump the Queue_ we need to provide two
