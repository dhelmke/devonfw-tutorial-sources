...
image::images/oasp4j/4.Components/oasp4j_architecture.png[width="250", link="images/oasp4j/4.Components/oasp4j_architecture.png"]
...
An _Entity_ is simply a https://en.wikipedia.org/wiki/Plain_old_Java_object[POJO]
