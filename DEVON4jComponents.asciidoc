...
Now we can add our first table _Visitor_. In the case of _Jump the Queue_, the visitors will provide: _username_, _name_, _password_, _phoneNumber_, _acceptedCommercial_ and _acceptedTerms_ to obtain an _access code_. So we need to represent that data in our table 
...
As second table we will represent the _Access Code_ that will be formed by the _ticketNumber_, _creationTime_, _startTime_ and the _endTime_. 
...
As third table we will represent the _Daily Queue_ that will be formed by _name_, _logo_, _currentNumber_, _attentionTime_, _minAttentionTime_, _active_ and the _customers_. 
...
image::images/devon4j/4.Components/cobigen2_crud_springdata_repository.png[link="images/devon4j/4.Components/cobigen2_crud_rest_services_cto.png"]

* _CRUD REST services_: generates a complete service layer with CRUD operations for our entity exposed as a REST service.

image::images/devon4j/4.Components/cobigen2_crud_rest_services.png[link="images/devon4j/4.Components/cobigen2_crud_rest_services_cto.png"]

* _CRUD UC logic_: generates the logic layer dividing the implementation in different use cases.

image::images/devon4j/4.Components/cobigen2_crud_uc_logic.png[link="images/devon4j/4.Components/cobigen2_crud_uc_logic_cto.png"]
...
image::images/devon4j/4.Components/cobigen2_to.png[link="images/devon4j/4.Components/cobigen2_cto.png"]
...
image::images/devon4j/4.Components/cobigen3_allpackages.png[link="images/devon4j/4.Components/cobigen3_allpackages_cto.png"]
