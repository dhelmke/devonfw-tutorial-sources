...
As second table we will represent the _Daily Queue_ that will be formed by _name_, _logo_, _currentNumber_, _attentionTime_, _minAttentionTime_, _active_ and the _customers_. This table will be created at  in `db/type/h2/V0006__Create_Queue.sql`:
...
As third table we will represent the _Access Code_ that will be formed by the _ticketNumber_, _creationTime_, _startTime_ and the _endTime_. This table will be created at  in `db/type/h2/V0007__Create_Access_Code.sql`
