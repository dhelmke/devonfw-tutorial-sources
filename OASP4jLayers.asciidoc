...
in the body we need to define the _SearchCriteria_ object, that will be empty in this case
...
=== link:OASP4jAddingCustomFunctionality[Next chapter: Customizing an Oasp4j project]