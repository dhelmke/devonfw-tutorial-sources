...
This is the most common workflow with Observables. Take into account that if you put some code after the Subscribe, it will be probably executed before the subscribe ends, if you need something to be executed before the subscribe function, you should put it inside.

https://angular.io/guide/http#rxjs-library[Here] you can will find more information about RxJs and Observables coming from the main page of Angular.
