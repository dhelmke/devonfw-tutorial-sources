...
. xref:BuildOASP4Japplication#buildyourownoasp4japplication[Create your own OASP4J application]
. xref:OASP4jComponents#createyourcomponents[Create your components]
. xref:OASP4jLayers#layersofthejumpthequeueapplication[Layers of the application]
. xref:OASP4jLayers#jumpthequeuerunning[Run the application]
. xref:OASP4jAddingCustomFunctionality#returntheaccesscode[Customize the application]
. xref:OASP4jTesting#testingourapplication[Testing the application]

*Building the client*

. xref:BuildOASP4JsApplication#goalofjumpthequeue[Create your own OASP4JS application]
. xref:BuildOASP4JsApplication#creatingcomponents[Create your components]
. xref:BuildOASP4JsApplication#creatingservices[Create services]
. xref:BuildOASP4JsApplication#makingcallstoserver[Make calls to the server]
