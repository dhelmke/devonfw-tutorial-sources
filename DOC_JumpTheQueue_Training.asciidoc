...
xref:JumpTheQueueDesign#Introduction[Jump the Queue introduction and requirements description]

*Building the server*

. xref:BuildOASP4Japplication#Build-your-own-OASP4J-application[Create your own OASP4J application]
. xref:OASP4jComponents#create-your-components[Create your components]
. xref:OASP4jLayers#layers-of-the-jump-the-queue-application[Layers of the application]
. xref:OASP4jLayers#jump-the-queue-running[Run the application]
. xref:OASP4jAddingCustomFunctionality#return-the-access-code[Customize the application]
. xref:OASP4jTesting#testing-our-application[Testing the application]

*Building the client*

. xref:BuildOASP4JsApplication#goal-of-jump-the-queue[Create your own OASP4JS application]
. xref:BuildOASP4JsApplication#creating-components[Create your components]
. xref:BuildOASP4JsApplication#creating-services[Create services]
. xref:BuildOASP4JsApplication#making-calls-to-server[Make calls to the server]
