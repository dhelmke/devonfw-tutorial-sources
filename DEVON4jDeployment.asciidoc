...
1. Go to `\java\jtqj\server\target` directory. You should find a `jtqj-server-{version}.war` there.

2. Change the _.war_ name to something easier like `jtqj.war`
...
image::images/devon4j/9.Deployment/jumpthequeue_simpleget2.png[, link="images/devon4j/9.Deployment/jumpthequeue_simpleget2.png"]