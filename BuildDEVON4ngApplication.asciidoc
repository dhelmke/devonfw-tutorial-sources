...
image::images/devon4ng/3.BuildYourOwn/mockups.png[,width="250", link="images/devon4ng/3.BuildYourOwn/mockups.png"]
...
In the case that you are unable to set up the extensions using the method mentioned, you can also use the scripts provided in https://github.com/devonfw/devonfw-extension-pack-vscode[this repository].
