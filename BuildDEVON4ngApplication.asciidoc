...
WARNING: If you got the DEVON distribution, the only thing you need to do in this step is intall the `devonfw Platform Extension Pack` in visual studio. After that, you can skip the rest and continue from link:#creating-basic-new-project-with-devcon[Here] 
