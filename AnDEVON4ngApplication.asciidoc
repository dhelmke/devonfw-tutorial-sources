...
image::images/devon4ng/2.Example_app/mts.png[, link="images/devon4ng/2.Example_app/mts.png"]
...
From now on we are going to focus on the implementation of the components, services and directives to show how is it formed and how you can create your own _Devon4ng_ client project with Devon framework.
...
= link:BuildDEVON4ngApplication[Next chapter: Create your own DEVON4ng app]